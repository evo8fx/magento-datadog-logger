...
use Monkey\DatadogLogger\Formatter\ElasticsearchFormatter;
use Monkey\DatadogLogger\Model\Api\Record\ElasticsearchClientInterface;
use Exception;
...
{
    const CONFIG_ENABLED            = 'datadog_logger/elasticsearch/enabled';
    const CONFIG_ACCEPTABLE_LEVEL   = 'datadog_logger/elasticsearch/acceptable_level';
    const CONFIG_DEV_MODE_ENABLE    = 'datadog_logger/elasticsearch/enabled_in_developer_mode';
