...
namespace Monkey\DatadogLogger\Model\Elastic\Record;
 ...
 * Class Send
 *
 * @package Monkey\DatadogLogger\Model\Elastic\Record
 */
class Client implements ElasticsearchClientInterface
{
    const CONFIG_CONNECTION = 'datadog_logger/elasticsearch/connection';
    const CONFIG_STORE_SUFFIX = 'datadog_logger/elasticsearch/index_suffix';
