...
{
    const CONFIG_DD_HTTP_REGION = 'datadog_logger/datadog/http_endpoint/account_region';
    const CONFIG_DD_HTTP_API_KEY = 'datadog_logger/datadog/http_endpoint/api_key';
    const CONFIG_DD_HTTP_INTAKE_URLS = 'datadog_logger/datadog/http_endpoint/intake_url';
